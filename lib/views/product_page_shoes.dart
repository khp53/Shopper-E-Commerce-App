...
class ProductPageShoes extends StatefulWidget {
  ...
  const ProductPageShoes(
      {Key key, this.pName, this.desc, this.price, this.fav, this.img})
      : super(key: key);

  @override
  _ProductPageShoesState createState() => _ProductPageShoesState();
}

class _ProductPageShoesState extends State<ProductPageShoes> {
  ...
  final List<String> size = ['UK 6', 'UK 8', 'UK 10', 'UK 10.5', 'UK 11'];
  String _currentSize = 'UK 10';

  static String red = '#FF534D';
  static String grey = '#575757';
  static String black = '#232323';
  static String blue = '#4E8FFF';
  static String white = '#ECECEC';
  static String pink = '#FF4BB1';

  final List<String> color = [red, grey, black, blue, white, pink];
                                  ...
                                  children: [
                                    Expanded(
                                      child: DropdownButtonFormField(
                                        ...
                                        selectedItemBuilder:
                                          ...
                                          return size.map<Widget>((String s) {
                                            return Container(
                                    ...
                                    Expanded(
                                      child: DropdownButtonFormField(
                                        ...
                                        selectedItemBuilder:
                                            (BuildContext context) {
                                          return color.map<Widget>((String c) {
                                            return Container(
